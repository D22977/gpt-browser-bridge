# Control Tower Skill v1

## Purpose
Provide a reusable cross-project Control role that can bootstrap a new project, rehydrate after chat/control rotation, supervise Worker/Reviewer lanes, and fail closed when local runtime capability is not current.
